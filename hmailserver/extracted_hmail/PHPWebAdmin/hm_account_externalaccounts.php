...
<h1><?php echo $obLanguage->String(STR_EXTERNAL_ACCOUNTS)?></h1>

<table border="0" class="settingsborder" width="100%" cellpadding="5">
	<tr>
		<td width="30%"><?php echo $obLanguage->String(STR_NAME)?></td>
		<td width="20%"><?php echo $obLanguage->String(STR_SERVER_ADDRESS)?></td>
		<td width="20%"></td>
		<td width="20%"></td>
	</tr>
...
$str_downloadnow = $obLanguage->String(STR_DOWNLOAD_NOW);
...
<tr>
   <td>
      <br>
      <a href="?page=account_externalaccount&action=add&domainid=<?php echo $domainid?>&accountid=<?php echo $accountid?>"><i><?php echo $obLanguage->String(STR_BUTTON_ADD)?></i></a>
   </td>
</tr>
</table>

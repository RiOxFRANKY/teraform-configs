...
if (defined('VERSIONCHECK_PHP')) $lang_versioncheck_php = array(
  ...
  'help_local_version_na1' => 'Non se puido extraer a información da versión do cvs', //cpg1.4
  'help_local_version_na2' => 'O script non puido determinar que versión do cvs é a do arquivo que hai no teu servidor web. Tes que subir o arquivo dende o teu paquete de arquivos.', //cpg1.4
  ...
  'no_webcvs_link' => 'non amosar ligazón do cvs no web', //cpg1.4
  'stable_webcvs_link' => 'amosar ligazón do cvs no web a unha póla estable', //cpg1.4
  'devel_webcvs_link' => 'amosar ligazón do cvs no web a unha póla en desenvolvemento', //cpg1.4

...
$lang_translation_info = array(
  ...
  'trans_email' => 'giasher@gmaol.com',
  'trans_website' => 'http://www.gia.ge/',
  'trans_date' => '2006-11-16',
);
...
$lang_main_menu = array(
  ...
  'faq_title' => 'ფრიად აქტუალური კითხვები &quot;Coppermine&quot; გალერეის შესახებ',
  'faq_lnk' => 'ფრიად აქტუალური კითხვები',
);

$lang_gallery_admin_menu = array(
  'upl_app_title' => 'ახალი ატვირთვების უფლება', //cpg1.4
  'upl_app_lnk' => 'ატვირთვის დასტური',
  'admin_title' => 'გადასვლა კონფიგურაციაზე', //cpg1.4
  'admin_lnk' => 'კონფიგურაცია', //cpg1.4
  ...
  'util_title' => 'გადასვლა ადმინისტრატორის ხელსაწყოებზე', //cpg1.4
  'util_lnk' => 'ადმინის ხელსაწყოები',
...
$lang_img_nav_bar = array(
  ...
  'report_title' => 'ამ ფაილის ადმინისტრატორისთვის პატაკი', //cpg1.4
...
$lang_version_alert = array(
  ...
  'relocate_exists' => 'ამოშალეთ <a href="http://coppermine-gallery.net/forum/index.php?topic=24217.0" target=_blank>relocate_server.php</a> ფაილი თქვენი საიტიდან!',
...
if (defined('BRIDGEMGR_PHP')) $lang_bridgemgr_php = array(
  'title' => 'დაკავშირების გამძღოლი',
  'warning' => 'გაფრთხილება: ამ გამძღოლის გამოყენებისას უნდა გაითვალისწინოთ, რომ მნიშვნელოვანი მონაცემები html ფორმით გაიგზავნება. გამოიყენეთ მხოლოდ საკუთარ კომპიუტერზე (და არა საზოგადო კომპიუტერზე ან ინტერნეტ კაფეში) და დასრულების შემდეგ გადაამოწმეთ, რომ ბუფერი გასუფთავებულია და დროებითი ფაილები წაშლილი, რათა სხვებმა თქვენი მონაცემების წაკითხვა ვერ შეძლონ!',
  'back' => 'უკან',
  'next' => 'შემდეგ',
  'start_wizard' => 'დაკავშირების გამძღოლის დაწყება',
  'finish' => 'დასრულება',
  ...
  'error_cookie_not_readible' => 'გალერეა ვერ კითხულობს ნაწდევის სახელით %s. შეასწორეთ მითითებული მნიშვნელობა %s პარამეტრისთვის, ან გადადით ფორუმის ადმინის პანელში და გადაამოწმეთ ნაჭდევის გეზის მისაწვდომობა გალერეისთვის.',
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
  ...
  'expand_all' => 'ყველას გაშლა', //cpg1.4
  'notice1' => '(*) თუ მონაცემთა ბაზაში ფაილები უკვე გაქვთ ეს პარამეტრები არ უნდა შეიცვალოს.', //cpg1.4 - (relocated)
  'notice2' => '(**) ამ პარამეტრების ცვლილება შეეხება მხოლოდ ამ ცვლილების შემდეგ ჩამოტვირთულ ფაილებს, ამიტომ ამ პარამეტრების შეცვლა თუ გალერეაში უკვე გაქვთ ფაილები რეკომენდებული არაა. თუმცა ცვლილებები შეგიძლიათ განახოციელოთ უკვე არსებული ფაილებისთვისაც &quot;<a href="util.php">ადმინის ხელსაწყოებით</a> (ზომის შეცვლა)&quot; ადმინისტრატორის მენიუდან.', //cpg1.4 - (relocated)
...
if (defined('ADMIN_PHP')) $lang_admin_data = array(
  ...
  array('დაშიფრული პაროლების გააქტივება (can not be undone)','enable_encrypted_passwords',1, 'f=index.htm&amp;as=admin_general_encrypt_password_start&amp;ae=admin_general_encrypt_password_end&amp;top=1'), // cpg 1.4
...
$lang_fullsize_popup = array(
  'click_to_close' => 'დაწკაპეთ ნახატი ამ ფანჯრის დასახურად',
);
...
if (defined('REPORT_FILE_PHP') || defined('DISPLAYREPORT_PHP')) $lang_report_php =array(
  ...
  'invalid_data' => 'პატაკის მონაცემები, რომლის გახსნაც გსურთ დაზიანდა თქვენი ელფოსტის კლიენტის მიერ. შეამოწმეთ ბმის მართებულობა.', //cpg1.4
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'num_file_upload' => 'Fფაილის ატვირთვის უჯრები', //cpg1.4
...
if (defined('KEYWORDMGR_PHP')) $lang_keywordmgr_php = array(
  ...
  'delete' => 'წაშლა', //cpg1.4
  'search' => 'ძიება', //cpg1.4
  'keyword_test_search' => 'ძიება ახალ ფანჯარაში - %s', //cpg1.4
...
<br />
ეს საიტი თქვენს კომპიუტერში ინფორმაციის შესანახად ნაჭდევებს იყენებს.  ეს ნაჭდევები არ შეიცვს თქვენს მიერ მშეტანილ ინფორმაციას და მხოლოდ საიტის უკეთ მუშაობას ემსახურება.  თწვნი ელფოსტა გამოიყენება რეგისტრაციის გასააქტივებლად და დავიწყების შემთხვევაში ახალი პაროლის გამოსაგზავნად.<br />
<br />
...
$lang_util_php = array(
  ...
  'delete_all_orphans' => 'წავშალო ყველა განცაკევებული?', //cpg1.4
  'comment' => 'კომენტარი: ',
  ...
  'update_db_explanation' => 'თუ გალერეის სიტემური ფაილი შეცვალეთ, დაამატეთ მოდიფიკაციები ან თავად პროგრამა განაახლეთ, აუცილებელია მონაცემთა ბაზის ერთხელ მაინც განახლება. ამ დროს შეიქმნება თქვენი მონაცცემთა ბაზისთვის აუცილებელი ცხრილები და/ან პარამეტრები.',
...
<h1>XP ვებ გამოცემის გამძღოლის მოდული</h1><p>ეს მოდული გალერეის <b>Windows XP</b> ვებ გამოცემის გამძღოლის გამოყენების საშუალებას იძლევა.</p><p>კოდი დაფუძნებულია სტატიაზე რომელის ავტორია
EOT;

$lang_xp_publish_required = <<<EOT
<h2>რა არის საჭირო</h2><ul><li>Windows XP შესაბამისი გამძღოლით.</li><li>გალერეის ჩადგმული მუშა ვერსია, რომელშიც <b>ვებ ატვირთვის ფუნქცია გამართულად მუშაობს.</b></li></ul><h2>როგორ ჩაიდგას კლიენტის მხარეს</h2><ul><li>გამოიყენეთ მარჯვენა დაწკაპვა
EOT;
...
<h2>შემოწმება</h2><ul><li>შეარჩიეთ რამდენიმე ფაილი Windows გამძღოლში და მარცხენა პანელში დაწკაპეთ <b>xxx გამოცემა ვებზე</b>.</li><li>დაადასტურეთ ფაილის თქვენი არჩევანი. დაწკაპეთ <b>შემდეგ</b>.</li><li>სერვისების სიაში შეარჩიეთ ერთერთი ფოტოგალერეა (თქვენი ერთერთი გალერეის სახელი). თუ სერვისები არ გამოჩნდა გადაამოწმეთ, რომ <b>cpg_pub_wizard.reg</b> ჩადგმულია არსებული ინსტრუქციების მიხედვით.</li><li>თუ საჭიროა მიუთითეთ თქვენი შესვლის მონაცემები.</li><li>მიუთითეთ თქვენი ნახატების დანიშნულების ალბომი ან შექმენით ახალი.</li><li>დაწკაპეთ <b>შემდეგ</b>. დაიწყება თქვენი ნახატების ატვირთვა.</li><li>დასრულების შემდეგ გადაამოწმეთ რამდენად მართებულად აიტვირთა ნახატები გალერეაში.</li></ul>
EOT;

$lang_xp_publish_notes = <<<EOT
<h2>Notes :</h2><ul><li>ატვირთვის დაწყების შემდეგ გამძღოლი სკრიპტის შეცდომის შეტყობინებებს ვეღარ აჩვენებს, ასე რომ, გალერეის შემოწმებამდე ვერ დაადგენთ თუ რამდენად მართებულად აიტვირთა ნახატები.</li><li>თუ ატვირთვა ვერ მოხერხდა, გალერეის მართვის გვერდზე ჩართეთ &quot;გამართვის რეჟიმი&quot;, ჯერ ერთი ნახატი სცადეთ და შემდეგ შეამოწმეთ შეცდომათა შეტყობინებები
EOT;

$lang_xp_publish_flood = <<<EOT
რომელიც თქვენს სერვერზე გალერეის დასტაშია განთავსებული.</li><li>გამძღოლის მიერ ატვირთული ნახატებით გალერეის <i>გადავსების</i> თავიდან ასაცილებლად ამ ფუნქციის გამოყენება მხოლოდ <b>გალერეის ადმინსა</b> და <b>საკუთარი ალბომების მქონე მონაწილეებს</b> შეუძლიათ.</li>
EOT;



$lang_xp_publish_php = array(
  'title' => 'გალერეა - XP ვებ გამოცემის გამძღოლი', //cpg1.4
  'welcome' => 'მოგესალმებით <b>%s</b>,', //cpg1.4
  'need_login' => 'ამ გამძღოლის გამოსაყენებლად ჯერ გალერეაში უნდა შეხვიდეთ ვებ ბრაუზერის საშუალებით.<p/><p>შესვლისას არ დაგავიწყდეთ <b>დამიმახსოვრე</b> პარამეტრის ჩართვა (თუ არის).', //cpg1.4
  'no_alb' => 'ვწუხვართ, მაგრამ ალბომი, რომელშიც ამ გამძღოლით ფაილების ატვირთვა შეგიძლიათ არ არსებობს.', //cpg1.4
  ...
  'continue' => 'დააჭირეთ &quot;შემდეგ&quot; თქვენი ფოტოების ატვირთვის დასაწყებად', //cpg1.4
  'link' => 'ეს ბმა', //cpg1.4
);
}
?>

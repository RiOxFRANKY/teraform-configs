...
$lang_translation_info = array(
  'lang_name_english' => 'Vietnamese', //cpg1.4
  'lang_name_native' => 'Tieng Viet', //cpg1.4
  'lang_country_code' => 'vn', //cpg1.4
  'trans_name'=> 'Webanhso.NET',
  'trans_email' => '',
  'trans_website' => 'http://webanhso.net/',
  'trans_date' => '2007-04-05',
);
...
// For the word censor
$lang_bad_words = array('*địt*', 'đít', 'đéo', 'cặc*', 'nồn', 'lồn', 'chó', 'thằng', 'mày', 'đĩ', 'điếm', 'bòi', 'bòy', 'buồi', 'ghẹ', 'bựa', 'foreskin', 'Fu\(*', 'fuk*', 'honkey', 'hore', 'injun', 'kike', 'lesbo', 'masturbat*', 'motherfucker', 'nazis', 'nigger*', 'nutsack', 'penis', 'phuck', 'poop', 'pussy', 'scrotum', 'shit', 'slut', 'titties', 'titty', 'twaty', 'wank*', 'whore', 'wop*');

$lang_meta_album_names = array(
  'random' => 'Ảnh ngẫu nhiên',
  'lastup' => 'Ảnh mới',
  'lastalb'=> 'Album mới',
  'lastcom' => 'Lời bình cuối',
  'topn' => 'Top xem',
  'toprated' => 'Top đánh giá',
  'lasthits' => 'Lần xem cuối',
  'search' => 'Kết quả',
  'favpics'=> 'Ảnh của bạn',  //cpg1.4
);

$lang_errors = array(
  'access_denied' => 'Bạn ko có quyền truy cập trang này.',
  'perm_denied' => 'Bạn ko có quyền thực hiện thao tác này.',
  'param_missing' => 'Script called without the required parameter(s).',
  'non_exist_ap' => 'Album (Ảnh) ko tồn tại !',
  'quota_exceeded' => 'Đã vượt quá dung lượng cho phép.',
  'gd_file_type_err' => 'Với GD, chỉ có ảnh JPEG và PNG được chấp nhận.',
  'invalid_image' => 'Ảnh bạn đã upload bị lỗi hoặc ko phù hợp với GD',
  'resize_failed' => 'Unable to create thumbnail or reduced size image.',
  'no_img_to_display' => 'Không có ảnh',
  'non_exist_cat' => 'Category ko tồn tại',
  ...
  'banned' => 'Bạn bị cấm truy cập site này.',
...
$lang_main_menu = array(
  'home_title' => 'Tới trang chủ',
  'home_lnk' => 'Trang chủ',
  'alb_list_title' => 'Xem danh sách Album',
  'alb_list_lnk' => 'Danh sách Album',
  'my_gal_title' => 'Xem Gallery của bạn',
  'my_gal_lnk' => 'Gallery của bạn',
  'my_prof_title' => 'Thông tin cá nhân', //cpg1.4
  ...
  'upload_pic_lnk' => 'Upload ảnh',
  'register_title' => 'Tạo tài khoản',
  'register_lnk' => 'Đăng ký',
  'login_title' => 'Đăng nhập', //cpg1.4
  'login_lnk' => 'Đăng nhập',
  'logout_title' => 'Thoát', //cpg1.4
  'logout_lnk' => 'Thoát',
  'lastup_title' => 'Ảnh mới upload gần đây', //cpg1.4
  'lastup_lnk' => 'Mới cập nhật',
  'lastcom_title' => 'Những lời bình gần đây', //cpg1.4
  'lastcom_lnk' => 'Lời bình cuối',
  'topn_title' => 'Xem nhiều nhất', //cpg1.4
  'topn_lnk' => 'Xem nhiều nhất',
  'toprated_title' => 'Ảnh được nhiều người bình chọn', //cpg1.4
  'toprated_lnk' => 'Đánh giá cao',
  'search_title' => 'Tìm kiếm ảnh', //cpg1.4
  'search_lnk' => 'Tìm kiếm',
  'fav_title' => 'Mục ảnh riêng của bạn', //cpg1.4
  'fav_lnk' => 'Ảnh của bạn',
  'memberlist_title' => 'Hiển thị danh sách thành viên',
  'memberlist_lnk' => 'Danh sách thành viên',
...
$lang_user_admin_menu = array(
  'albmgr_title' => 'Quản lý Album của tôi', //cpg1.4
  'albmgr_lnk' => 'Tạo/Sắp xếp Album',
  'modifyalb_title' => 'Go to modify my albums',  //cpg1.4
  'modifyalb_lnk' => 'Sửa Album',
  'my_prof_title' => 'Go to my personal profile', //cpg1.4
  'my_prof_lnk' => 'Sửa thông tin cá nhân',
);
...
$lang_album_list = array(
  'album_on_page' => '%d albums trên %d trang',
);
...
$lang_thumb_view = array(
  ...
  'sort_na' => 'Xếp theo tên từ dưới lên',
  'sort_nd' => 'Xếp theo tên từ trên xuống',
  'sort_ta' => 'Xếp theo tiêu đề từ dưới',
  'sort_td' => 'Xếp theo tiêu đề từ trên',
  'position' => 'POSITION', //cpg1.4
  'sort_pa' => 'Xếp theo ngày đăng tăng dần', //cpg1.4
  'sort_pd' => 'Xếp theo ngày đăng giảm dần', //cpg1.4
  'download_zip' => 'Download file zip',
  'pic_on_page' => '%d ảnh trên %d trang',
  'user_on_page' => '%d users on %d page(s)',
  'enter_alb_pass' => 'Nhập mật mã Album', //cpg1.4
  'invalid_pass' => 'Sai mật mã', //cpg1.4
  'pass' => 'Password', //cpg1.4
  'submit' => 'Submit', //cpg1.4
);

$lang_img_nav_bar = array(
  'thumb_title' => 'Quay lại trang trước',
  'pic_info_title' => 'Ẩn/Hiện thông tin',
  'slideshow_title' => 'Xem trình diễn',
  'ecard_title' => 'Gửi thiệp Online',
  'ecard_disabled' => 'Chưa kích hoạt Gửi thiệp',
  'ecard_disabled_msg' => 'Bạn ko có quyền gửi thiệp', //js-alert
  'prev_title' => 'Xem ảnh trước',
  'next_title' => 'Xem ảnh tiếp theo',
  'pic_pos' => 'FILE %s/%s',
  'report_title' => 'Thông báo ảnh này tới người quản trị', //cpg1.4
  'go_album_end' => 'Xem Album cuối cùng', //cpg1.4
  'go_album_start' => 'Xem Album đầu', //cpg1.4
  'go_back_x_items' => 'go back %s items', //cpg1.4
  'go_forward_x_items' => 'go forward %s items', //cpg1.4
);

$lang_rate_pic = array(
  'rate_this_pic' => 'Đánh giá ảnh này ',
  'no_votes' => '(Chưa có bình chọn nào)',
  'rating' => '(Bình chọn hiện tại: %s / 5 với %s phiếu)',
  'rubbish' => 'Quá xấu',
  'poor' => 'Xấu',
  'fair' => 'Trung bình',
  'good' => 'Khá',
...
$lang_display_thumbnails = array(
  'filename' => 'Tên ảnh=', //cpg1.4
  'filesize' => 'Dung lượng=', //cpg1.4
  'dimensions' => 'Kích thước=', //cpg1.4
  'date_added' => 'Ngày đăng=', //cpg1.4
);

$lang_get_pic_data = array(
  'n_comments' => '%s Lời bình',
  'n_views' => '%s Lần xem',
  'n_votes' => '(%s Bình chọn)',
);
...
$lang_language_selection = array(
  'reset_language' => 'Ngôn ngữ gốc',
  'choose_language' => 'Chọn quốc gia',
);
...
$lang_picinfo = array(
  ...
  'Rating' => 'Bình chọn (%s phiếu)',
  'Keywords' => 'Từ khóa',
  'File Size' => 'Dung lượng',
  'Date Added' => 'Ngày đăng', //cpg1.4
  ...
  'Comment' => 'Lời bình',
  'addFav'=>'Đưa vào mục Ảnh của bạn',
  'addFavPhrase'=>'Bạn có thích ảnh này?',
  'remFav'=>'Xóa ảnh',
...
$lang_display_comments = array(
  ...
  'add_your_comment' => 'Lời bình của bạn',
  'name'=>'Tên',
  'comment'=>'Nội dung',
  'your_name' => 'Anon',
  'report_comment_title' => 'Thông báo nội dung của lời bình này tới Admin', //cpg1.4
);

$lang_fullsize_popup = array(
  'click_to_close' => 'Kích vào ảnh để đóng cửa sổ này',
);
...
$lang_list_categories = array(
  'home' => 'Home',
  'stat1' => '<b>[pictures]</b> ảnh trong <b>[albums]</b> albums và <b>[cat]</b> chuyên mục với <b>[comments]</b> lời bình, đã xem <b>[views]</b> lần',
...
$lang_list_albums = array(
  'n_pictures' => '%s Bức ảnh',
  'last_added' => ', Ảnh upload mới nhất vào %s',
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
  'login' => 'Đăng nhập',
  'enter_login_pswd' => 'Điền tên đăng nhập và mật khẩu',
  'username' => 'Tên đăng nhập',
  'password' => 'Mật khẩu',
  'remember_me' => 'Lưu thông tin đăng nhập',
  'welcome' => 'Welcome %s ...',
  'err_login' => '*** Ko thể đăng nhập. Thử lại ***',
  'err_already_logged_in' => 'Bạn đã đăng nhập !',
  'forgot_password_link' => 'Tôi quên mật khẩu',
...
$lang_register_php = array(
  ...
  'err_user_exists' => 'Tên đăng nhập đã tồn tại, hãy chọn tên khác',
  'err_password_mismatch' => 'Hai mật khẩu phải giống nhau, hãy nhập lại',
  'err_uname_short' => 'Tên đăng nhập ít nhất 2 kí tự',
  'err_password_short' => 'Mật khẩu ít nhất 2 kí tự',
  'err_uname_pass_diff' => 'Tên đăng nhập và mật khẩu phải khác nhau',
  'err_invalid_email' => 'Địa chỉ Email ko hợp lệ',
  'err_duplicate_email' => 'Email đã có người sử dụng, hãy nhập email khác',
  ...
  'interests' => 'Sở thích',
  'website' => 'Website',
  'occupation' => 'Có người iu chưa ?',
  'error' => 'Lỗi',
  'confirm_email_subject' => '%s - Kiểm tra thông tin đăng ký',
  'information' => 'Thông tin',
  'failed_sending_email' => 'Email kiểm tra ko thể gửi !',
  'thank_you' => 'Cảm ơn bạn đã đăng ký.<br /><br />Một Email với thông tin kích hoạt tài khoản đã được gửi tới email của bạn.',
  'acct_created' => 'Tài khoản của bạn đã được tạo và bạn có thể đăng nhập',
  'acct_active' => 'Tài khoản của bạn đã được kích hoạt và bạn có thể đăng nhập',
  'acct_already_act' => 'Tài khoản đã kích hoạt!', //cpg1.4
  'acct_act_failed' => 'Tài khoản ko thể kích hoạt !',
  'err_unk_user' => 'Tên đăng nhập ko tồn tại !',
  'x_s_profile' => '%s\'s hồ sơ',
  'group' => 'Nhóm',
  'reg_date' => 'Ngày gia nhập',
  'disk_usage' => 'Dung lượng sử dụng',
  'change_pass' => 'Thay đổi mật khẩu',
  'current_pass' => 'Mật khẩu hiện tại',
  'new_pass' => 'Mật khẩu mới',
  'new_pass_again' => 'Nhập lại mật khẩu mới',
  'err_curr_pass' => 'Sai mật khẩu hiện tại',
  'apply_modif' => 'Đồng ý',
  'change_pass' => 'Thay mật khẩu',
  'update_success' => 'Hồ sơ đã được cập nhật',
  'pass_chg_success' => 'Thay đổi mật khẩu thành công',
  'pass_chg_error' => 'Việc thay đổi thất bại',
  'notify_admin_email_subject' => '%s - Registration notification',
  'last_uploads' => 'Ảnh mới upload.<br />Kích vào để xem ảnh upload bởi', //cpg1.4
  'last_comments' => 'Lời bình cuối.<br />Kích vào để xem lời bình tạo bởi', //cpg1.4
  'notify_admin_email_body' => 'A new user with the username "%s" has registered in your gallery',
  'pic_count' => 'Files uploaded', //cpg1.4
  'notify_admin_request_email_subject' => '%s - Yêu cầu kích hoạt', //cpg1.4
  'thank_you_admin_activation' => 'Cảm ơn bạn.<br /><br />Yêu cầu kích hoạt tài khoản đã được gửi tới người quản trị. Bạn sẽ nhận được email nếu được phê chuẩn.', //cpg1.4
  'acct_active_admin_activation' => 'Tài khoản đã được kích hoạt và một email đã được gửi.', //cpg1.4
  'notify_user_email_subject' => '%s - Thông tin kích hoạt', //cpg1.4
);

$lang_register_confirm_email = <<<EOT
Cảm ơn bạn đã đăng ký thành viên tại {SITE_NAME}

Để kích hoạt tài khoản "{USER_NAME}", bạn cần kích vào link dưới đây hoặc copy và gõ vào trình duyệt web.

<a href="{ACT_LINK}">{ACT_LINK}</a>

Chúc bạn vui vẻ !

Quản trị viên của {SITE_NAME}
...
Để kích hoạt tài khoản, bạn cần kích vào link dưới đây hoặc copy và gõ vào trình duyệt web.
...
Tài khoản của bạn đã được phê chuẩn và kích hoạt.

Bạn có thể đăng nhập tại <a href="{SITE_LINK}">{SITE_LINK}</a> sử dụng tên đăng nhập "{USER_NAME}"
...
$lang_search_php = array(
  'title' => 'Tìm ảnh trên Website này, Gõ từ vào', //cpg1.4
  'submit_search' => 'Tìm kiếm', //cpg1.4
  'keyword_list_title' => 'Danh sách từ khóa', //cpg1.4
  'keyword_msg' => 'Hãy cố gắng tìm với nhiều lựa chọn để được kết quả tối ưu.',  //cpg1.4
  'edit_keywords' => 'Sửa từ khóa', //cpg1.4
  'search in' => 'Tìm theo:', //cpg1.4
  'ip_address' => 'Địa chỉ IP', //cpg1.4
  'fields' => 'Tìm theo', //cpg1.4
  'age' => 'Khoảng', //cpg1.4
  'newer_than' => 'Gần đây', //cpg1.4
  'older_than' => 'Cách đây', //cpg1.4
  'days' => 'Ngày', //cpg1.4
  'all_words' => 'Chứa cụm từ vừa nhập', //cpg1.4
  'any_words' => 'Một trong những từ nhập', //cpg1.4
);

$lang_adv_opts = array(
  'title' => 'Tiêu đề', //cpg1.4
  'caption' => 'Đầu đề', //cpg1.4
  'keywords' => 'Từ khóa', //cpg1.4
  'owner_name' => 'Tên thành viên', //cpg1.4
  'filename' => 'Tên ảnh', //cpg1.4
);

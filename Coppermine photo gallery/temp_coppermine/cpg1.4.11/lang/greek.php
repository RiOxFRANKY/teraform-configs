...
$lang_bbcode_help = 'Μπορείτε να προσθέσετε συνδέσεις (clickable links) και κάποιου είδους μορφοποίηση σε αυτό το πεδίο χρησιμοποιώντας bbcode ετικέττες (τags): <li>[b]Έντονα[/b] =&gt; <b>Έντονα</b></li><li>[i]Κεκλιμένα[/i] =&gt; <i>Κεκλιμένα</i></li><li>[url=http://yoursite.com/]Url της ιστοσελίδας σας[/url] =&gt; <a href="http://yoursite.com">Url της ιστοσελίδας σας</a></li><li>[email]user@domain.com[/email] =&gt; <a href="mailto:user@domain.com">user@domain.com</a></li><li>[color=red]κείμενο[/color] =&gt; <span style="color:red">κείμενο</span></li><li>[img]http://coppermine.sf.net/demo/images/red.gif[/img] => <img src="../images/red.gif" border="0" alt="" /></li>'; //cpg1.4
...
if (defined('VERSIONCHECK_PHP')) $lang_versioncheck_php = array(
  ...
  'no_webcvs_link' => 'να μη  εμφανιστεί ο σύνδεσμος web cvs', //cpg1.4
  'stable_webcvs_link' => 'εμφάνιση συνδέσμου web cvs σε σταθερό κλάδο', //cpg1.4
  'devel_webcvs_link' => 'εμφάνιση συνδέσμου web cvs σε devel κλάδο', //cpg1.4

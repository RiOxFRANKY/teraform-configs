...
$lang_bbcode_help = '您可以用 bbcode 加入可点的连接，和其它的文字格式： <li>[b]粗体[/b] =&gt; <b>粗体</b></li><li>[i]斜体[/i] =&gt; <i>斜体</i></li><li>[url=http://yoursite.com/]网址[/url] =&gt; <a href="http://yoursite.com">网址</a></li><li>[email]user@domain.com[/email] =&gt; <a href="mailto:user@domain.com">user@domain.com</a></li><li>[color=red]颜色[/color] =&gt; <span style="color:red">颜色</span></li><li>[img]http://coppermine.sf.net/demo/images/red.gif[/img] => <img src="../images/red.gif" border="0" alt="" /></li>'; //cpg1.4

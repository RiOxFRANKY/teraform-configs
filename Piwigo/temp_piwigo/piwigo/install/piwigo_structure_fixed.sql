...
CREATE TABLE `piwigo_categories` (
  ...
  `comment` text,
  `dir` varchar(191) default NULL,
  `rank` smallint(5) unsigned default NULL,
  `status` enum('public','private') NOT NULL default 'public',
  `site_id` tinyint(4) unsigned default NULL,
  `visible` enum('true','false') NOT NULL default 'true',
  `representative_picture_id` mediumint(8) unsigned default NULL,
  `uppercats` varchar(191) NOT NULL default '',
  `commentable` enum('true','false') NOT NULL default 'true',
  `global_rank` varchar(191) default NULL,
...
CREATE TABLE `piwigo_images` (
  ...
  `file` varchar(191) binary NOT NULL default '',
...
CREATE TABLE `piwigo_sessions` (
  `id` varchar(191) binary NOT NULL default '',
...
CREATE TABLE `piwigo_sites` (
  ...
  `galleries_url` varchar(191) NOT NULL default '',
  PRIMARY KEY  (`id`),
...
CREATE TABLE `piwigo_tags` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `name` varchar(191) binary NOT NULL default '',
  `url_name` varchar(191) binary NOT NULL default '',
  PRIMARY KEY  (`id`),
...
CREATE TABLE `piwigo_user_infos` (
  ...
  `theme` varchar(191) NOT NULL default 'elegant',
...
CREATE TABLE `piwigo_users` (
  ...
  `mail_address` varchar(191) default NULL,
  PRIMARY KEY  (`id`),
